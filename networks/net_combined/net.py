...
class Network(nn.Module):
    ...
    def forward(self, input):
        C_real_unet_in = self.C__in(input)
        C_real_unet__D_Output_0_shortcut_0 = self.C_B_0_DS_p(C_real_unet_in)
        output_0003 = self.C__D_B_0_0_compress_p(C_real_unet__D_Output_0_shortcut_0)
        ...
        C_real_unet__D_Output_0_comp_0 = self.C__D_B_0_0_decompress_p(output_0006)
        C_real_unet__D_Output_0_shortcut_1 = C_real_unet__D_Output_0_shortcut_0 + C_real_unet__D_Output_0_comp_0
        output_0009 = self.C__D_B_0_1_compress_p(C_real_unet__D_Output_0_shortcut_1)
        ...
        C_real_unet__D_Output_0_comp_1 = self.C__D_B_0_1_decompress_p(output_0012)
        C_real_unet__D_Output_0 = C_real_unet__D_Output_0_shortcut_1 + C_real_unet__D_Output_0_comp_1
        C_real_unet__D_Output_1_shortcut_0 = self.C_B_1_DS_p(C_real_unet__D_Output_0)
        output_0016 = self.C__D_B_1_0_compress_p(C_real_unet__D_Output_1_shortcut_0)
        ...
        C_real_unet__D_Output_1_comp_0 = self.C__D_B_1_0_decompress_p(output_0019)
        C_real_unet__D_Output_1_shortcut_1 = C_real_unet__D_Output_1_shortcut_0 + C_real_unet__D_Output_1_comp_0
        output_0022 = self.C__D_B_1_1_compress_p(C_real_unet__D_Output_1_shortcut_1)
        ...
        C_real_unet__D_Output_1_comp_1 = self.C__D_B_1_1_decompress_p(output_0025)
        C_real_unet__D_Output_1 = C_real_unet__D_Output_1_shortcut_1 + C_real_unet__D_Output_1_comp_1
        C_real_unet__D_Output_2_shortcut_0 = self.C_B_2_DS_p(C_real_unet__D_Output_1)
        output_0029 = self.C__D_B_2_0_compress_p(C_real_unet__D_Output_2_shortcut_0)
        ...
        C_real_unet__D_Output_2_comp_0 = self.C__D_B_2_0_decompress_p(output_0032)
        C_real_unet__D_Output_2_shortcut_1 = C_real_unet__D_Output_2_shortcut_0 + C_real_unet__D_Output_2_comp_0
        output_0035 = self.C__D_B_2_1_compress_p(C_real_unet__D_Output_2_shortcut_1)
        ...
        C_real_unet__D_Output_2_comp_1 = self.C__D_B_2_1_decompress_p(output_0038)
        C_real_unet__D_Output_2 = C_real_unet__D_Output_2_shortcut_1 + C_real_unet__D_Output_2_comp_1
        C_real_unet__D_Output_3_shortcut_0 = self.C_B_3_DS_p(C_real_unet__D_Output_2)
        output_0042 = self.C__D_B_3_0_compress_p(C_real_unet__D_Output_3_shortcut_0)
        ...
        C_real_unet__D_Output_3_comp_0 = self.C__D_B_3_0_decompress_p(output_0045)
        C_real_unet__D_Output_3_shortcut_1 = C_real_unet__D_Output_3_shortcut_0 + C_real_unet__D_Output_3_comp_0
        output_0048 = self.C__D_B_3_1_compress_p(C_real_unet__D_Output_3_shortcut_1)
        ...
        C_real_unet__D_Output_3_comp_1 = self.C__D_B_3_1_decompress_p(output_0051)
        C_real_unet__D_Output_3 = C_real_unet__D_Output_3_shortcut_1 + C_real_unet__D_Output_3_comp_1
        C_real_unet__D_Output_4_shortcut_0 = self.C_B_4_DS_p(C_real_unet__D_Output_3)
        output_0055 = self.C__D_B_4_0_compress_p(C_real_unet__D_Output_4_shortcut_0)
        ...
        C_real_unet__D_Output_4_comp_0 = self.C__D_B_4_0_decompress_p(output_0058)
        C_real_unet__D_Output_4_shortcut_1 = C_real_unet__D_Output_4_shortcut_0 + C_real_unet__D_Output_4_comp_0
        output_0061 = self.C__D_B_4_1_compress_p(C_real_unet__D_Output_4_shortcut_1)
        ...
        C_real_unet__D_Output_4_comp_1 = self.C__D_B_4_1_decompress_p(output_0064)
        C_real_unet__D_Output_4 = C_real_unet__D_Output_4_shortcut_1 + C_real_unet__D_Output_4_comp_1
        C_real_unet__U_Output_4_upsampled = self.C_B_4_US_p(C_real_unet__D_Output_4)
        C_real_unet__U_Output_4_upsampled_summed = C_real_unet__U_Output_4_upsampled + C_real_unet__D_Output_3
        output_0069 = self.C__U_B_4_0_compress_p(C_real_unet__U_Output_4_upsampled_summed)
        ...
        C_real_unet__U_Output_4_comp_0 = self.C__U_B_4_0_decompress_p(output_0072)
        C_real_unet__U_Output_4_shortcut_1 = C_real_unet__U_Output_4_upsampled_summed + C_real_unet__U_Output_4_comp_0
        output_0075 = self.C__U_B_4_1_compress_p(C_real_unet__U_Output_4_shortcut_1)
        ...
        C_real_unet__U_Output_4_comp_1 = self.C__U_B_4_1_decompress_p(output_0078)
        C_real_unet__U_Output_4 = C_real_unet__U_Output_4_shortcut_1 + C_real_unet__U_Output_4_comp_1
        C_real_unet__U_Output_3_upsampled = self.C_B_3_US_p(C_real_unet__U_Output_4)
        C_real_unet__U_Output_3_upsampled_summed = C_real_unet__U_Output_3_upsampled + C_real_unet__D_Output_2
        output_0083 = self.C__U_B_3_0_compress_p(C_real_unet__U_Output_3_upsampled_summed)
        ...
        C_real_unet__U_Output_3_comp_0 = self.C__U_B_3_0_decompress_p(output_0086)
        C_real_unet__U_Output_3_shortcut_1 = C_real_unet__U_Output_3_upsampled_summed + C_real_unet__U_Output_3_comp_0
        output_0089 = self.C__U_B_3_1_compress_p(C_real_unet__U_Output_3_shortcut_1)
        ...
        C_real_unet__U_Output_3_comp_1 = self.C__U_B_3_1_decompress_p(output_0092)
        C_real_unet__U_Output_3 = C_real_unet__U_Output_3_shortcut_1 + C_real_unet__U_Output_3_comp_1
        C_real_unet__U_Output_2_upsampled = self.C_B_2_US_p(C_real_unet__U_Output_3)
        C_real_unet__U_Output_2_upsampled_summed = C_real_unet__U_Output_2_upsampled + C_real_unet__D_Output_1
        output_0097 = self.C__U_B_2_0_compress_p(C_real_unet__U_Output_2_upsampled_summed)
        ...
        C_real_unet__U_Output_2_comp_0 = self.C__U_B_2_0_decompress_p(output_0100)
        C_real_unet__U_Output_2_shortcut_1 = C_real_unet__U_Output_2_upsampled_summed + C_real_unet__U_Output_2_comp_0
        output_0103 = self.C__U_B_2_1_compress_p(C_real_unet__U_Output_2_shortcut_1)
        ...
        C_real_unet__U_Output_2_comp_1 = self.C__U_B_2_1_decompress_p(output_0106)
        C_real_unet__U_Output_2 = C_real_unet__U_Output_2_shortcut_1 + C_real_unet__U_Output_2_comp_1
        C_real_unet__U_Output_1_upsampled = self.C_B_1_US_p(C_real_unet__U_Output_2)
        C_real_unet__U_Output_1_upsampled_summed = C_real_unet__U_Output_1_upsampled + C_real_unet__D_Output_0
        output_0111 = self.C__U_B_1_0_compress_p(C_real_unet__U_Output_1_upsampled_summed)
        ...
        C_real_unet__U_Output_1_comp_0 = self.C__U_B_1_0_decompress_p(output_0114)
        C_real_unet__U_Output_1_shortcut_1 = C_real_unet__U_Output_1_upsampled_summed + C_real_unet__U_Output_1_comp_0
        output_0117 = self.C__U_B_1_1_compress_p(C_real_unet__U_Output_1_shortcut_1)
        ...
        C_real_unet__U_Output_1_comp_1 = self.C__U_B_1_1_decompress_p(output_0120)
        C_real_unet__U_Output_1 = C_real_unet__U_Output_1_shortcut_1 + C_real_unet__U_Output_1_comp_1
        C_real_unet_out_upsampled = self.C_B_0_US_p(C_real_unet__U_Output_1)
        C_real_unet_out_upsampled_summed = C_real_unet_out_upsampled + C_real_unet_in
        output_0125 = self.C__U_B_0_0_compress_p(C_real_unet_out_upsampled_summed)
        ...
        C_real_unet_out_comp_0 = self.C__U_B_0_0_decompress_p(output_0128)
        C_real_unet_out_shortcut_1 = C_real_unet_out_upsampled_summed + C_real_unet_out_comp_0
        output_0131 = self.C__U_B_0_1_compress_p(C_real_unet_out_shortcut_1)
        ...
        C_real_unet_out_comp_1 = self.C__U_B_0_1_decompress_p(output_0134)
        C_real_unet_out = C_real_unet_out_shortcut_1 + C_real_unet_out_comp_1
        C_real_estimate = self.C__out(C_real_unet_out)
        return C_real_estimate
