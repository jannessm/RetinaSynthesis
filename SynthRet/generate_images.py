...
parser.add_argument('-N', type=int, dest='N', help='amount of images to generate', default=2000)
...
parser.add_argument('--dest', dest='dest', default='./data', help='output path for the generated images')
